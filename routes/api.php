...
Route::middleware(['auth:sanctum'])->group(function() {
    ...
    Route::get('/getUserPersonalDetails', 'EmployeeController@getUserPersonalDetails');
    Route::get('/getUserLeaveCredits', 'EmployeeController@getUserLeaveCredits');
    ...
    Route::prefix('hr')->name('hr.')->group(function () {
        ...
        Route::patch('/coes/{id}/approved', 'Api\HumanResource\COEController@acknowledged')->name('coes.acknowledge');
    ...
    Route::patch('/overtimes/{id}/approveOvertime', 'Api\OvertimeController@approveStatus');
    Route::patch('/overtimes/{id}/disapproveOvertime', 'Api\OvertimeController@disapproveStatus');
